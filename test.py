...
def apply_artsyle_close(frame, h, w, style_transfer_model):
    ...
    style_transfer_model_1.setInput(inp_close)
    stylized_output_close = style_transfer_model_1.forward()
...
def apply_artsyle_far(frame, h, w, style_transfer_model):
    ...
    style_transfer_model_2.setInput(inp_far)
    stylized_output_far = style_transfer_model_2.forward()
